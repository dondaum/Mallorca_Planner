...
RSpec.feature "Create a new resevation", :type => :feature do
  scenario "Visitor gets from rooth pag to new reservation path" do
  ...
  scenario "Visitor create a mew reservation" do
    ...
    fill_in 'reservation_comment', with: 'MWir freuen uns'
